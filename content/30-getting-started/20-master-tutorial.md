...
See [Installation](../10-installation) and come back here once you have
...
Please take a look at [The Nvidia page](../../90-nvidia) before launching. It has
...
If you are on systemd, some services like XDG Desktop Portal may **require** you to start a proper graphical session with systemd. 
Systemd also provides additional features such as 
[xdg-autostart](https://www.freedesktop.org/software/systemd/man/latest/systemd-xdg-autostart-generator.html) support, 
launching any application as a systemd-unit, and the ability to enable services for programs that rely on a graphical 
session and provide such services (e.g waybar). 
See the [uwsm page](../../70-useful-utilities/140-uwsm) for further instructions.
...
Check out the [Preconfigured setups page](../30-preconfigured-setups)
...
Head onto the
[Configuring Hyprland page](../../40-configuring) to learn all
about configuring Hyprland to your liking.

## Monitors config

See [Configuring Hyprland page](../../40-configuring/10-core/10-monitors) to learn all about
configuring your displays.

## Important software

See the [Must-have software page](../../70-useful-utilities/10-must-have) for the
crucial things to make Wayland / Hyprland / other apps work correctly.

## Apps / X11 replacements

See the [Useful Utilities page](../../70-useful-utilities)
...
[here](../../40-configuring/10-core/70-environment-variables).
...
[this FAQ entry on changing your mouse cursor](../../120-faq#how-do-i-change-me-mouse-cursor)

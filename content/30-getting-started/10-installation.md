...
> [!NOTE]
> NVIDIA GPUs are often not usable out-of-the-box, follow the [Nvidia page](../../90-nvidia) after installing
...
For more details, read the [Nix page](../../80-nix).
...
[XDPH](../../50-hypr-ecosystem/10-user/60-xdg-desktop-portal-hyprland) and
...
>
> Note: Your mileage may vary, as GDM has some bugs with Hyprland. Check the [Master Tutorial](../20-master-tutorial) for more info.
>
...
See [Crashes and Bugs](../../110-crashes-and-bugs).

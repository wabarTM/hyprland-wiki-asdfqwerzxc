...
[the Master Tutorial](../30-getting-started/20-master-tutorial#force-apps-to-use-wayland).

If they can't, see [the XWayland page](../40-configuring/40-extra/50-xwayland).
...
To diagnose if you have the exact problem above you can get a [DRM log](../110-crashes-and-bugs#debugging-drm-issues) and look for
...
Check [Screensharing](../70-useful-utilities/40-screen-sharing).

Also install `qt6-wayland` if you plan to use obs.

### How do I change my wallpaper?

See [Wallpapers](../70-useful-utilities/30-wallpapers).
...
See [hyprcursor](../50-hypr-ecosystem/20-dev/20-hyprcursor)
...
See [Environment Variables](../40-configuring/10-core/70-environment-variables)
...
See [The XDPH Page](../50-hypr-ecosystem/10-user/60-xdg-desktop-portal-hyprland#debugging).
...
[Here](../40-configuring/10-core/60-rules/20-workspace-rules/#smart-gaps).

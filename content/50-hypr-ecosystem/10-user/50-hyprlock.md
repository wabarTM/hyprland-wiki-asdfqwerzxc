...
Hyprlock uses the following types in addition to Hyprland's [data types](../../../20-naming-conventions#data-types).
...
Check out Hyprland's [animation documentation](../../../40-configuring/10-core/80-animations) for more information.
...
The [`locked` flag](../../../40-configuring/10-core/50-binds/10-flags#bind-flags) `l` can be used to allow specific hyprland keybinds to also work while hyprlock is active (e.g. brightness/volume/media control).
...
See [Monitors](../../../40-configuring/10-core/10-monitors).

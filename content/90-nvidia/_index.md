...
1. Try changing the primary GPU [with the AQ_DRM_DEVICES environment variable](../40-configuring/40-extra/10-multi-gpu#telling-hyprland-which-gpu-to-use).
...
> [!WARNING]
> [Loading the Nvidia modules early](../90-nvidia#early-kms-modeset-and-fbdev) may cause resuming from hibernation to not work anymore (i.e. the system will just boot instead of resuming).
> If you have issues with that, try disabling early KMS.

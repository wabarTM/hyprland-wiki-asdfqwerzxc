...
To get information (e.g., class, size, tags, etc.), use: 
- `hyprctl clients` --- to get about all open windows, use `hyprctl clients`
- `hyprctl activewindow` --- to get infromation about active window.

...
| mfact | change mfact, the master split ratio | the new split ratio, a relative float delta (e.g., `-0.2`, `+0.2`) or `exact` followed by a the exact float value between 0.0 and 1.0 |

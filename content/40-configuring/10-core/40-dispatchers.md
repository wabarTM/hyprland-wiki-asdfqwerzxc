...
On the other hand, [hl.exec_cmd](../100-advanced-configuration/10-expanding-functionality#hlexec_cmd-function) is a postman. Never gets or answers any calls, just goes straight to the address on the letter.
...
| --- | --- |
| `window` | [Window selector](../../../20-naming-conventions#window-selector) |
...
| `global( string )` | Activate a dbus global shortcut. See [Global shortcuts](../50-binds/50-globals) |
...
Props are any of the _dynamic effects_ of [Window Rules](../60-rules/10-window-rules#dynamic-effects).

...
| mode | Resolution and refresh rate, e.g. `"1920x1080@144"`. See the [note](./30-modes#modes) for predefined positions. Options: `mode`/`"preferred"`/`"highres"`/`"highrr"`/`"maxwidth"` | str | `"preferred"` |
...
| position | Position in the virtual layout, e.g. `"1920x0"` See the [note](./20-positioning#positions) for predefined modes | str | `"auto"` |
...
See [Workspace Rules](../60-rules/20-workspace-rules).

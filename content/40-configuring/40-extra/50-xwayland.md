...
[force_zero_scaling](../../10-core/20-config-options#xwayland) option set to true,
...
Keeping that in mind, we add the [create_abstract_socket](../../10-core/20-config-options#xwayland) option.

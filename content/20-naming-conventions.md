...
There are implicit conversions between certain types, however, this may lead to undefined behaviour later. Lsp with lua stub can be used to warn about the use of wrong type. More on that can be read [here](../40-configuring/10-core#autocompletions)
...
Monitor can be selected by:
 - Monitor object
 - Monitor ID
 - [Output selector](../40-configuring/10-core/10-monitors/10-output-selection)
 - [Direction](#direction)
 - `current`

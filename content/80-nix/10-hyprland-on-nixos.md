...
relevant section in [Hyprland with Home Manager](../30-hyprland-with-home-manager).
...
provides options similar to the ones in the [Home Manager module](../30-hyprland-with-home-manager).
